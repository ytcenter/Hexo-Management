...
function show_password(){
    ...
    $('#password_icon').html(hide_html);
    $('#password_icon').attr('href', 'javascript:hide_password();');
    $('#password_icon').attr('data-bs-original-title', '隐藏密码');
}
...
function hide_password(){
    ...
    $('#password_icon').html(show_html);
    $('#password_icon').attr('href', 'javascript:show_password();')
    $('#password_icon').attr('data-bs-original-title', '显示密码');
}
